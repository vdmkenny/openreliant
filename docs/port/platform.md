...
It shows the ship in the chase view against the backdrop, drawn through the ported pipeline and
driver ([Renderer](renderer.md)) onto the software device, whose frames go to the screen through
SDL's GPU interface. Escape or closing the window quits.
